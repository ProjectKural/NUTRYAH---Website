        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Access Your Health Data Anytime, Anywhere.`,
              description: `Effortlessly book consultations, view meal plans, and track progress—all in one place. Stay connected to your health journey with ease!`,
            }}
          />
