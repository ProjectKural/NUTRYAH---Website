      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              >
                <a href="/" className="relative">
                  <Image
                    width={110}
                    height={80}
                    src="/images/logo/Nutyahlogo.png"
                    alt="Logo"
                ...
                <p className="mb-10 mt-5">
                  Nutryah – Personalized Nutrition for a Healthier You!
                </p>
              </motion.div>
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        href="#"
                        className="mb-3 text-black hover:text-primary"
                      >
                        support@nutryah.com
                      </a>
                    </li>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Nutryah Digital Health Pvt
                ...
                <li>
                  <a href="#" aria-label="social icon">
                    ...
                    >
                      <g clipPath="url(#clip0_48_1508)">
                        <path
                          d="M7.75 2C4.12665 2 2 4.12665 2 7.75V16.25C2 19.8733 4.12665 22 7.75 22H16.25C19.8733 22 22 19.8733 22 16.25V7.75C22 4.12665 19.8733 2 16.25 2H7.75ZM18 5C18.5523 5 19 5.44772 19 6C19 6.55228 18.5523 7 18 7C17.4477 7 17 6.55228 17 6C17 5.44772 17.4477 5 18 5ZM12 7C14.7614 7 17 9.23858 17 12C17 14.7614 14.7614 17 12 17C9.23858 17 7 14.7614 7 12C7 9.23858 9.23858 7 12 7ZM12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9Z"
                          fill=""
                        />
                      </g>
                      <defs>
