...
export const LegalPage = () => {
    return (
        <div className="px-6 md:px-12 py-20 max-w-12xl mx-auto bg-[#03468A]">
            <Helmet>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center text-white">Privacy Policy & Legal Information</h1>

            <section className="mb-12">
                <h2 className="text-2xl font-semibold mb-3 text-white">Privacy Policy</h2>
                <p className="text-white mb-4">Your privacy is important to us. This section explains how Nutryah collects, uses, and protects your information:</p>
            ...
            <section className="mb-12">
                <h2 className="text-2xl font-semibold mb-3 text-white">Terms of Use</h2>
                <ul className="list-disc list-inside text-white space-y-2">
            ...
            <section className="mb-12">
                <h2 className="text-2xl font-semibold mb-3 text-white">Compliance & Disclaimer</h2>
                <ul className="list-disc list-inside text-white space-y-2">
            ...
            <p className="text-sm text-white">
                For any clarifications, feel free to <Link to="/contact" className="text-white underline">contact us</Link>.
            </p>
        </div>
    );
};